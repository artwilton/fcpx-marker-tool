...
class TimecodeInfo:
    ...
    def __init__(self, frame_rate, start, duration, drop_frame=False, offset=None):
        ...
        self.drop_frame = drop_frame # Boolean, True for DF and False for NDF
        self.offset = offset # int representing start frame within a timeline, optional because usually only clips have this property
        self._timecode = Timecode(frame_rate, frames=(start + 1), force_non_drop_frame=drop_frame)
